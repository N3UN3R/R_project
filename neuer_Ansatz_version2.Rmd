...
print(colnames(bestandteile_Typ11))
print(colnames(bestandteile_Typ11))

glimpse(bestandteile_Typ11)
#glimpse(bestandteile_carosserie_K4)

glimpse(bestandteile_motor_K1DI1)
```
#aus komponenten die Bestandteile der Kompoenente matchen--> Einzelteil IDs 
```{r, message=FALSE, warning = FALSE, cache = TRUE}
#basierend auf dem vorletzten schritt können nun die entsprechenden dataframes gemachted werden
...
bauteile_carosserie_typ11 <- semi_join(bestandteile_carosserie_K4, bestandteile_Typ11, by = c("ID_K4" = "ID_Karosserie"))
bauteile_carosserie_typ12 <- semi_join(bestandteile_carosserie_K5, bestandteile_Typ12, by = c("ID_K5" = "ID_Karosserie"))
bauteile_carosserie_typ21 <- semi_join(bestandteile_carosserie_K6, bestandteile_Typ21, by = c("ID_K6" = "ID_Karosserie"))
bauteile_carosserie_typ22 <- semi_join(bestandteile_carosserie_K7, bestandteile_Typ22, by = c("ID_K7" = "ID_Karosserie"))

#typ 11 hat "K3SG1" "K3AG1"als schaltungen
bauteile_schaltung1_typ11 <- semi_join(bestandteile_schaltung_K3AG1, bestandteile_Typ11, by = c("ID_K3AG1" = "ID_Schaltung"))
bauteile_schaltung2_typ11 <- semi_join(bestandteile_schaltung_K3SG1, bestandteile_Typ11, by = c("ID_K3SG1" = "ID_Schaltung"))
#typ 12 hat "K3SG1" "K3AG1"als Schaltungen
bauteile_schaltung1_typ12 <- semi_join(bestandteile_schaltung_K3AG1, bestandteile_Typ12, by = c("ID_K3AG1" = "ID_Schaltung"))
bauteile_schaltung2_typ12 <- semi_join(bestandteile_schaltung_K3SG1, bestandteile_Typ12, by = c("ID_K3SG1" = "ID_Schaltung"))
#type 21 hat "K3AG2" "K3SG2" als SChaltungen
bauteile_schaltung1_typ21 <- semi_join(bestandteile_schaltung_K3AG2, bestandteile_Typ21, by = c("ID_K3AG2" = "ID_Schaltung"))
bauteile_schaltung2_typ21 <- semi_join(bestandteile_schaltung_K3SG2, bestandteile_Typ21, by = c("ID_K3SG2" = "ID_Schaltung"))
#type 22 hat "K3AG2" "K3SG2 als Schaltungen
bauteile_schaltung1_typ22 <- semi_join(bestandteile_schaltung_K3AG2, bestandteile_Typ21, by = c("ID_K3AG2" = "ID_Schaltung"))
bauteile_schaltung2_typ22 <- semi_join(bestandteile_schaltung_K3SG2, bestandteile_Typ21, by = c("ID_K3SG2" = "ID_Schaltung"))

#type 11 hat die sitze "K2LE1" "K2ST1"
bauteile_sitze1_typ11 <- semi_join(bestandteile_sitze_K2LE1, bestandteile_Typ11, by = c("ID_K2LE1" = "ID_Sitze"))
bauteile_sitze2_typ11 <- semi_join(bestandteile_sitze_K2ST1, bestandteile_Typ11, by = c("ID_K2ST1" = "ID_Sitze"))
#type 12 hat die sitze "K2LE1" "K2ST1"
bauteile_sitze1_typ12 <- semi_join(bestandteile_sitze_K2LE1, bestandteile_Typ12, by = c("ID_K2LE1" = "ID_Sitze"))
bauteile_sitze2_typ12 <- semi_join(bestandteile_sitze_K2ST1, bestandteile_Typ12, by = c("ID_K2ST1" = "ID_Sitze"))
#type 21 hat die sitze  "K2ST2" "K2LE2"
bauteile_sitze1_typ21 <- semi_join(bestandteile_sitze_K2LE2, bestandteile_Typ21, by = c("ID_K2LE2" = "ID_Sitze"))
bauteile_sitze2_typ21 <- semi_join(bestandteile_sitze_K2ST2, bestandteile_Typ21, by = c("ID_K2ST2" = "ID_Sitze"))
#type 22 hat die sitze  "K2ST2" "K2LE2"
bauteile_sitze1_typ22 <- semi_join(bestandteile_sitze_K2LE2, bestandteile_Typ22, by = c("ID_K2LE2" = "ID_Sitze"))
bauteile_sitze2_typ22 <- semi_join(bestandteile_sitze_K2ST2, bestandteile_Typ22, by = c("ID_K2ST2" = "ID_Sitze"))

#type 11 hat die motoren "K1BE1" "K1DI1
bauteile_motor1_typ11 <- semi_join(bestandteile_motor_K1BE1, bestandteile_Typ11, by = c("ID_K1BE1" = "ID_Motor"))
bauteile_motor2_typ11 <- semi_join(bestandteile_motor_K1DI1, bestandteile_Typ11, by = c("ID_K1DI1" = "ID_Motor"))
#type 12 hat die motoren "K1BE1" "K1DI1
bauteile_motor1_typ12 <- semi_join(bestandteile_motor_K1BE1, bestandteile_Typ12, by = c("ID_K1BE1" = "ID_Motor"))
bauteile_motor2_typ12 <- semi_join(bestandteile_motor_K1DI1, bestandteile_Typ12, by = c("ID_K1DI1" = "ID_Motor"))
#type 21 hat die motoren "K1BE2" "K1DI2"
bauteile_motor1_typ21 <- semi_join(bestandteile_motor_K1BE2, bestandteile_Typ21, by = c("ID_K1BE2" = "ID_Motor"))
bauteile_motor2_typ21 <- semi_join(bestandteile_motor_K1DI2, bestandteile_Typ21, by = c("ID_K1DI2" = "ID_Motor"))
#type 21 hat die motoren "K1BE2" "K1DI2"
bauteile_motor1_typ22 <- semi_join(bestandteile_motor_K1BE2, bestandteile_Typ22, by = c("ID_K1BE2" = "ID_Motor"))
bauteile_motor2_typ22 <- semi_join(bestandteile_motor_K1DI2, bestandteile_Typ22, by = c("ID_K1DI2" = "ID_Motor"))
```
...
a <- bind_rows(bauteile_carosserie_typ11,bauteile_carosserie_typ12,bauteile_carosserie_typ21,bauteile_carosserie_typ22)
glimpse(a)
b <- bind_rows(bauteile_schaltung1_typ11,bauteile_schaltung2_typ11,bauteile_schaltung1_typ12,bauteile_schaltung2_typ12,bauteile_schaltung1_typ21,bauteile_schaltung2_typ21,bauteile_schaltung1_typ22,bauteile_schaltung2_typ22)

glimpse(b)


c <- bind_rows(bauteile_sitze1_typ11,bauteile_sitze2_typ11,bauteile_sitze1_typ12,bauteile_sitze2_typ12,bauteile_sitze1_typ21,bauteile_sitze2_typ12,bauteile_sitze1_typ21,bauteile_sitze2_typ21,bauteile_sitze1_typ22,bauteile_sitze2_typ22)

glimpse(c)


d <- bind_rows(bauteile_motor1_typ11,bauteile_motor2_typ11,bauteile_motor1_typ12,bauteile_motor2_typ12,bauteile_motor1_typ21,bauteile_motor2_typ21,bauteile_motor1_typ22,bauteile_motor2_typ22)
