...
```
# hier troubleshooting
```{r, message=FALSE, warning = FALSE, cache = TRUE}


glimpse(bestandteile_motor_K1BE2)

glimpse(bestandteile_motor_K1DI2)
...
glimpse(bauteile_motor1_typ21)
glimpse(bauteile_motor2_typ21)
...
# das hier ist nur zum testen und müll
```{r, message=FALSE, warning = FALSE, cache = TRUE}
#basierend auf dem vorletzten schritt können nun die entsprechenden dataframes gemachted werden
#über die zuvor identifizierten "unique keys" können wird gematched
