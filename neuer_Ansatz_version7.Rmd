...
part_T03 <- part_T03 %>%
  rename(
    # Die Spalte 'Fehlerhaft_Datum' wird in 'Fehlerhaft_Datum_T03' umbenannt.
    Fehlerhaft_Datum_T03 = Fehlerhaft_Datum,
    # Die Spalte 'Fehlerhaft_Fahrleistung' wird in 'Fehlerhaft_Fahrleistung_T03' umbenannt.
    Fehlerhaft_Fahrleistung_T03 = Fehlerhaft_Fahrleistung)

glimpse(part_T03)

#erstelle einen neued df mit spalten des alten
#wähle spalten aus gesamt df aus
selection_part_T03 <- select(part_T03,ID_T03,Fehlerhaft_Datum_T03, Fehlerhaft_Fahrleistung_T03)
glimpse(selection_part_T03)

all_df_selection_T03 <- select(all_df_data,ID_Fahrzeug, ID_T03)
#entferne na values aus df  für schnelleres matchen
#hier müssen wir auf jeden fall nochmal schauen, ob zu viele werte entfernt werden
all_df_selection_T03 <- na.omit(all_df_selection_T03)
glimpse(all_df_selection_T03)

#zusammenfügen der dataframes
final_df_T03 <- inner_join(all_df_selection_T03, selection_part_T03, by = "ID_T03")
#glimpse(final_df_T03)

#mit bisherigem dataframe zusammenführen
final_df_T03 <- inner_join(final_df_T02, final_df_T03, by = "ID_Fahrzeug")
glimpse(final_df_T03)
```
```{r, message=FALSE, warning = FALSE, cache = TRUE}
write.csv(final_df_T03, "final_df_T03.csv", row.names = TRUE)
```
...
part_T04 <- part_T04 %>%
  rename(
    # Die Spalte 'Fehlerhaft_Datum' wird in 'Fehlerhaft_Datum_T04' umbenannt.
    Fehlerhaft_Datum_T04 = Fehlerhaft_Datum,
    # Die Spalte 'Fehlerhaft_Fahrleistung' wird in 'Fehlerhaft_Fahrleistung_T04' umbenannt.
    Fehlerhaft_Fahrleistung_T04 = Fehlerhaft_Fahrleistung)

glimpse(part_T04)

#erstelle einen neued df mit spalten des alten
#wähle spalten aus gesamt df aus
selection_part_T04 <- select(part_T04,ID_T04,Fehlerhaft_Datum_T04, Fehlerhaft_Fahrleistung_T04)
glimpse(selection_part_T04)

all_df_selection_T04 <- select(all_df_data,ID_Fahrzeug, ID_T04)
#entferne na values aus df  für schnelleres matchen
#hier müssen wir auf jeden fall nochmal schauen, ob zu viele werte entfernt werden
all_df_selection_T04 <- na.omit(all_df_selection_T04)
glimpse(all_df_selection_T04)

#zusammenfügen der dataframes
final_df_T04 <- inner_join(all_df_selection_T04, selection_part_T04, by = "ID_T04")
#glimpse(final_df_T04)

#mit bisherigem dataframe zusammenführen
final_df_T04 <- inner_join(final_df_T03, final_df_T04, by = "ID_Fahrzeug")
glimpse(final_df_T04)
```
...
part_T05 <- part_T05 %>%
  rename(
    # Die Spalte 'Fehlerhaft_Datum' wird in 'Fehlerhaft_Datum_T05' umbenannt.
    Fehlerhaft_Datum_T05 = Fehlerhaft_Datum,
    # Die Spalte 'Fehlerhaft_Fahrleistung' wird in 'Fehlerhaft_Fahrleistung_T05' umbenannt.
    Fehlerhaft_Fahrleistung_T05 = Fehlerhaft_Fahrleistung)

glimpse(part_T05)

#erstelle einen neued df mit spalten des alten
#wähle spalten aus gesamt df aus
selection_part_T05 <- select(part_T05,ID_T05,Fehlerhaft_Datum_T05, Fehlerhaft_Fahrleistung_T05)
glimpse(selection_part_T05)

all_df_selection_T05 <- select(all_df_data,ID_Fahrzeug, ID_T05)
#entferne na values aus df  für schnelleres matchen
#hier müssen wir auf jeden fall nochmal schauen, ob zu viele werte entfernt werden
all_df_selection_T05 <- na.omit(all_df_selection_T05)
glimpse(all_df_selection_T05)

#zusammenfügen der dataframes
final_df_T05 <- inner_join(all_df_selection_T05, selection_part_T05, by = "ID_T05")
#glimpse(final_df_T05)

#mit bisherigem dataframe zusammenführen
final_df_T05 <- inner_join(final_df_T04, final_df_T05, by = "ID_Fahrzeug")
glimpse(final_df_T05)
```
...
part_T06 <- part_T06 %>%
  rename(
    # Die Spalte 'Fehlerhaft_Datum' wird in 'Fehlerhaft_Datum_T06' umbenannt.
    Fehlerhaft_Datum_T06 = Fehlerhaft_Datum,
    # Die Spalte 'Fehlerhaft_Fahrleistung' wird in 'Fehlerhaft_Fahrleistung_T06' umbenannt.
    Fehlerhaft_Fahrleistung_T06 = Fehlerhaft_Fahrleistung)

glimpse(part_T06)

#erstelle einen neued df mit spalten des alten
#wähle spalten aus gesamt df aus
selection_part_T06 <- select(part_T06,ID_T06,Fehlerhaft_Datum_T06, Fehlerhaft_Fahrleistung_T06)
glimpse(selection_part_T06)

all_df_selection_T06 <- select(all_df_data,ID_Fahrzeug, ID_T06)
#entferne na values aus df  für schnelleres matchen
#hier müssen wir auf jeden fall nochmal schauen, ob zu viele werte entfernt werden
all_df_selection_T06 <- na.omit(all_df_selection_T06)
glimpse(all_df_selection_T06)

#zusammenfügen der dataframes
final_df_T06 <- inner_join(all_df_selection_T06, selection_part_T06, by = "ID_T06")
#glimpse(final_df_T06)

#mit bisherigem dataframe zusammenführen
final_df_T06 <- inner_join(final_df_T05, final_df_T06, by = "ID_Fahrzeug")
glimpse(final_df_T06)
```
#7
```{r, message=FALSE, warning = FALSE, cache = TRUE}
...
part_T07 <- part_T07 %>%
  rename(
    # Die Spalte 'Fehlerhaft_Datum' wird in 'Fehlerhaft_Datum_T07' umbenannt.
    Fehlerhaft_Datum_T07 = Fehlerhaft_Datum,
    # Die Spalte 'Fehlerhaft_Fahrleistung' wird in 'Fehlerhaft_Fahrleistung_T07' umbenannt.
    Fehlerhaft_Fahrleistung_T07 = Fehlerhaft_Fahrleistung)

glimpse(part_T07)

#erstelle einen neued df mit spalten des alten
#wähle spalten aus gesamt df aus
selection_part_T07 <- select(part_T07,ID_T07,Fehlerhaft_Datum_T07, Fehlerhaft_Fahrleistung_T07)
glimpse(selection_part_T07)

all_df_selection_T07 <- select(all_df_data,ID_Fahrzeug, ID_T07)
#entferne na values aus df  für schnelleres matchen
#hier müssen wir auf jeden fall nochmal schauen, ob zu viele werte entfernt werden
all_df_selection_T07 <- na.omit(all_df_selection_T07)
glimpse(all_df_selection_T07)

#zusammenfügen der dataframes
final_df_T07 <- inner_join(all_df_selection_T07, selection_part_T07, by = "ID_T07")
#glimpse(final_df_T07)

#mit bisherigem dataframe zusammenführen
final_df_T07 <- inner_join(final_df_T06, final_df_T07, by = "ID_Fahrzeug")
glimpse(final_df_T07)
```
```{r, message=FALSE, warning = FALSE, cache = TRUE}
write.csv(final_df_T07, "final_df_T07.csv", row.names = TRUE)
```
...
# jetzt gehts automatisierter weiter
#hilfsunktion zum erstellen des dfs 
```{r, message=FALSE, warning = FALSE, cache = TRUE}
part_list <- sprintf("part_T%02d", 1:40)
print(part_list)

print(part_list[1])
df <- get(part_list[1])

# Funktion, die den Prozess für ein gegebenes Teil durchführt
process_part <- function(part_name, all_df_data, final_df) {
  # Dynamische Namen für die Auswahl und Umbenennung
  ...
  # Zugriff auf den spezifischen part DataFrame
  part_df <- get(paste0("part_", part_name))
  ...
  # Zusammenführen mit dem bisherigen finalen DataFrame, wenn nicht null
  if(!is.null(final_df)) {
    final_df <- inner_join(final_df, final_df_part, by = "ID_Fahrzeug", suffix = c("", paste0("_", part_name)))
  } else {
    final_df <- final_df_part
  }
...
#erstellen von 1 und dann loopen
```{r, message=FALSE, warning = FALSE, cache = TRUE}
...
# Initialisieren von final_df
final_df <- final_df_T01

# Annahme: Erstellen einer Liste von Teilen
part_list <- sprintf("T%02d", 2:40)

# Durchlaufen der Teilliste
for(part_name in part_list) {
  final_df <- process_part(part_name, all_df_data, final_df)
}

for(part_name in part_list) {
  # Generiere den Namen des DataFrames für den aktuellen Teil
  
  # Überprüfe, ob ein DataFrame mit diesem Namen existiert
  if(exists(part_name)) {
    # Wenn der DataFrame existiert, verarbeite ihn
    final_df <- process_part(part_name, all_df_data, final_df)
  } else {
    # Wenn der DataFrame nicht existiert, drucke eine Fehlermeldung
    print(paste("Fehler: Einzelteildatei nicht richtig eingelesen:", part_name))
  }
}
